        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 text-sm text-muted-foreground">
            ...
            <HelpSection
              ...
              text="Na aba Comparação você pode selecionar duas versões do seu software e visualizar diferenças de eficiência energética, uso de CPU, memória e pegada de carbono lado a lado."
            />
        ...
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 rounded-xl bg-muted/50">
              <div
                className="h-12 w-12 rounded-full grid place-items-center text-primary-foreground font-semibold text-lg shrink-0"
                style={{ background: "var(--gradient-primary)" }}
              >
